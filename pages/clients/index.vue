...
import { Search, ArrowLeft, Layers, Zap, Cpu, Terminal, Play } from 'lucide-vue-next'
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            <header class="text-center mb-16 relative">
                <NuxtLink :to="localePath('/')"
                    ...
                    <span class="text-xs uppercase tracking-widest font-bold">{{ t('back') }}</span>
                </NuxtLink>
                ...
                <p class="text-white/40 max-w-xl mx-auto text-lg mb-12 font-medium">
                    {{ t('clients.subtitle') }}
                </p>
                ...
                <div class="max-w-4xl mx-auto">
                    <div
                        ...
                        <div class="flex p-1 bg-black/20 rounded-2xl overflow-x-auto whitespace-nowrap no-scrollbar">
                            <button v-for="tab in tabs" :key="tab.id" @click="activeTab = tab.id" :class="[
                                ...
                                <span v-if="tab.count.value > 0"
                                    class="text-[10px] bg-black/20 px-1.5 py-0.5 rounded-md min-w-[20px] text-center"
                                    :class="activeTab === tab.id ? 'opacity-50' : ''">
                                    {{ tab.count.value }}
                                </span>
                            </button>
                        </div>
            ...
            <div v-else class="text-center py-40 bg-white/5 rounded-[3rem] border border-dashed border-white/10">
                ...
                <h3 class="text-2xl font-bold text-white mb-2">{{ t('no_clients_found') }}</h3>
